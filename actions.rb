...
action :multi_run_as,
       steps: [:child_1, OpsChain.steps([:child_2, :child_3], run_as: :parallel),
               :child_4, OpsChain.steps([:child_5, :child_6], run_as: :sequential),
               :child_7, OpsChain.steps([:child_8, :child_9], run_as: :parallel)],
       run_as: :sequential,
...
action :duplicate_step_1, step_name: "The Same Step Name", description: "duplicate_step_1"
action :duplicate_step_2, step_name: "The Same Step Name", description: "duplicate_step_2"
action :with_dup_children, steps: [:duplicate_step_1, :duplicate_step_2], description: 'Test duplicate child step names'

action "Defined With Step Name", description: "Test defined with step name" do
  puts "testing"
end
